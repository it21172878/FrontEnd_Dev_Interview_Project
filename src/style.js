const styles = {
  ...
  heading2:
    'font-poppins font-semibold xs:text-[28px] exs:text-[24px] exs:leading-[28px] text-[40px] sm:text-[23px] text-analogousColor1 xl:leading-[76.8px] xs:leading-[32px] sm:leading-[35px] leading-[66.8px] w-full xs:text-[25px]',
  paragraph:
