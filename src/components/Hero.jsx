...
const Hero = () => {
  return (
    <section
      ...
      className={` sm:bg-contain bg-hero-pattern bg-cover xl:bg-cover lg:bg-cover  elg:bg-cover xs:bg-contain bg-no-repeat flex md:flex-row flex-col ${styles.paddingY}`}
    >
      <div
